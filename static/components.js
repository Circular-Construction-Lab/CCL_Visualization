...
class Node {
	constructor(name_, architect_, year_, location_, continent_, typeStr_, aspectsStr_, imgUrl_, sourceUrl_, descript_, typeIcon_) {
		...
		//Moving settings
		this.p = new p5.Vector(random(windowWidth / 2 - windowWidth / 20 -200, windowWidth / 2 + windowWidth / 20 -200), random(windowHeight / 2 - windowHeight / 20, windowHeight / 2 + windowHeight / 20));
